...
def test_split_ratio():
    ...
    clean_path = os.path.join(repo_root, "data", "processed", "corpus_clean.txt")
    train_path = os.path.join(repo_root, "data", "processed", "train.txt")
    val_path = os.path.join(repo_root, "data", "processed", "val.txt")
