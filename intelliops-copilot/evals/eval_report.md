...
| **Average End-to-End Latency** | **0.0225s** | < 2.0s |
...
| :---: | :--- | :---: | :---: | :---: | :---: |
| 1 | `INC-001` | ✅ | ✅ | No | 0.0971s |
| 2 | `INC-002` | ✅ | ✅ | No | 0.0180s |
| 3 | `INC-003` | ✅ | ✅ | No | 0.0195s |
| 4 | `INC-004` | ✅ | ✅ | No | 0.0189s |
| 5 | `INC-005` | ✅ | ✅ | No | 0.0183s |
| 6 | `INC-006` | ✅ | ✅ | No | 0.0234s |
| 7 | `INC-007` | ✅ | ✅ | No | 0.0167s |
| 8 | `INC-008` | ✅ | ✅ | No | 0.0167s |
| 9 | `INC-009` | ✅ | ✅ | No | 0.0185s |
| 10 | `INC-010` | ✅ | ✅ | No | 0.0169s |
| 11 | `INC-011` | ✅ | ✅ | No | 0.0181s |
| 12 | `INC-012` | ✅ | ✅ | No | 0.0179s |
| 13 | `INC-013` | ✅ | ✅ | No | 0.0175s |
| 14 | `INC-014` | ✅ | ✅ | No | 0.0179s |
| 15 | `INC-015` | ✅ | ✅ | No | 0.0188s |
| 16 | `INC-016` | ✅ | ✅ | No | 0.0179s |
| 17 | `INC-001` | ✅ | ✅ | No | 0.0199s |
| 18 | `INC-004` | ✅ | ✅ | No | 0.0229s |
| 19 | `INC-006` | ✅ | ✅ | No | 0.0186s |
