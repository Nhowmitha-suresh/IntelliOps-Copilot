...
def load_model_and_tokenizer(
    checkpoint_path: str = "minigpt/experiments/checkpoints/best_model.pt",
...
def main():
    ...
    parser.add_argument(
        "--checkpoint",
        type=str,
        default="minigpt/experiments/checkpoints/best_model.pt",
        help="Path to model checkpoint",
    )
    parser.add_argument(
        "--tokenizer",
        type=str,
        default="minigpt/experiments/tokenizer.json",
