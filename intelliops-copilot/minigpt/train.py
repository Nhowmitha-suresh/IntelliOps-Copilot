...
def train(
    train_txt_path: str = "minigpt/data/processed/train.txt",
    val_txt_path: str = "minigpt/data/processed/val.txt",
    tokenizer_path: str = "minigpt/experiments/tokenizer.json",
    checkpoint_dir: str = "minigpt/experiments/checkpoints",
    log_dir: str = "minigpt/experiments/logs",
    plots_dir: str = "minigpt/experiments/plots",
