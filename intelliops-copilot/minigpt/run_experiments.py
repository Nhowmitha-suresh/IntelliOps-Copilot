...
from minigpt.minigpt_config import ModelConfig, TrainConfig
...
def run_full_experiments():
    ...
    train_path = "minigpt/data/processed/train.txt"
    val_path = "minigpt/data/processed/val.txt"
    tok_path = "minigpt/experiments/tokenizer.json"

    # -------------------------------------------------------------
    # 1. Baseline Model Training (3000 iterations)
    # -------------------------------------------------------------
    print("==================================================")
    print("STEP 1: Starting Baseline MiniGPT Training (3000 steps)...")
    print("==================================================")
    ...
    best_src = "minigpt/experiments/checkpoints/best_model.pt"
    best_dst = "minigpt/experiments/checkpoints/best.pt"
    ...
    # Save to minigpt/experiments/logs/sample_generations.md
    samples_md_path = "minigpt/experiments/logs/sample_generations.md"
    ...
    with open(samples_md_path, "w", encoding="utf-8") as f:
        ...
        f.write(f"**Checkpoint**: `minigpt/experiments/checkpoints/best_model.pt` (3,000 steps)\n\n")
        for temp in temperatures:
    ...
    # Temporary custom checkpoint & log paths for variant
    var_ckpt_dir = "minigpt/experiments/checkpoints_variant"
    var_log_dir = "minigpt/experiments/logs_variant"
    var_plots_dir = "minigpt/experiments/plots_variant"
    ...
    # Move variant log file to minigpt/experiments/logs/training_log_variant.csv
    variant_log_dest = "minigpt/experiments/logs/training_log_variant.csv"
    ...
    # -------------------------------------------------------------
    # 4. Comparison Plot (minigpt/experiments/plots/comparison.png)
    # -------------------------------------------------------------
    print("\n==================================================")
    print("STEP 4: Generating Comparison Plot...")
    print("==================================================")

    base_df = pd.read_csv("minigpt/experiments/logs/training_log.csv")
    var_df = pd.read_csv(variant_log_dest)

    comp_plot_path = "minigpt/experiments/plots/comparison.png"
    ...
    # -------------------------------------------------------------
    # 5. Write minigpt/experiments/logs/experiment_notes.md
    # -------------------------------------------------------------
    print("\n==================================================")
    ...
    notes_path = "minigpt/experiments/logs/experiment_notes.md"
    with open(notes_path, "w", encoding="utf-8") as f:
        ...
        f.write(f"| **Training Steps** | 3,000 | 3,000 |\n")
        ...
        f.write(f"- Both models demonstrated smooth loss convergence over 3,000 training steps.\n")
